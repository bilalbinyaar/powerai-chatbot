...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center">
      <div className="bg-zinc-950 w-full max-w-screen-md mg-white p-4 rounded-lg shadow-md shadow-gray-700">
        <div className="mb-4">
          <div className="text-4xl font-bold text-blue-800 mb-2">
            ChatBot Assistant
          </div>
          <p className="text-white-600 text-lg">
            Welcome to the future of AI-powered assistant. Ask me anyhting.
          </p>
        </div>
